...
public static class Creator
{
    ...
    {
        return new Plane(deviceType[0],RandomDeviceName(),RandomDeviceWeight(),RandomWhereCreated(),true,true,RandomCapacity(),RandomKilkrabochix());
    }

    public static Helicopter RandomHelicopter()
    {
        return new Helicopter(deviceType[1],RandomDeviceName(),RandomDeviceWeight(),RandomWhereCreated(),true,true,RandomMaxSpeed(),RandomMaxHeight());
    }

    public static Deltaplan RandomDeltaplan()
    {
        return new Deltaplan(deviceType[4],RandomDeviceName(),RandomDeviceWeight(),RandomWhereCreated(),false,true,RandomRazMaxKrila(),RandomMaxWeight());
    }

    public static Baloon RandomBaloon()
    {
        return new Baloon(deviceType[2],RandomDeviceName(),RandomDeviceWeight(),RandomWhereCreated(),false,false,RandomColor(),RandomSize());
        
    }

    public static MagicCarpet RandomMagicCarpet()
    {
        return new MagicCarpet(deviceType[3],RandomDeviceName(),RandomDeviceWeight(),RandomWhereCreated(),true,false,RandomVizerunok(),RandomHowManyKebab());
    }
